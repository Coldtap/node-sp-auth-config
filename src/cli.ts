...
program
  ...
  .option(
    '-p, --path [value]',
    "relative path to file which will store your credentials (default: './config/private.json')",
    './config/private.json'
  )
  .option(
    '-e, --encrypt [true, false]',
    "specify false if you don't need to encrypt password in the file (default: true)",
    true
  )
  .option(
    '-k, --masterkey [value]',
    'optional key used to encrypt and decrypt passwords (default: unique machine id)',
    null
  )
  .action(initAction);
...
program
  ...
  .option(
    '-e, --encrypt [true, false]',
    "specify false if you don't need to encrypt password in the file, optional (default: true)",
    true
  )
  .option(
    '-k, --masterkey [value]',
